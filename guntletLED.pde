...
class pattern {
 ...
 OscMessage myMessage2 = new OscMessage("/outputs/rgb/9"); //address pattern
    myMessage2.add(gauntletBlob); //puts blob into message
    //println(' myMessage: '+myMessage); //FOR DEBUG
    oscP5.send(myMessage2, gauntletLoc);//sends blob over
